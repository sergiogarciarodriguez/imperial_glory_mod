...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_AUSTRIA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_AUSTRIA_ATACANTE_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_AUSTRIA_ATACANTE_3")
  ...
  fade_color (245,255,250,0, 245,255,250,255,maxTime-2,2)
