...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara20Letonia.V3D",0.0,false,1.0);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_ATACANTE_1")
  ...
  fade_color (255,255,255,255, 255,255,255,0,0,5)
  fade_color (255,255,255,0, 255,255,255,255,maxTime-0.4,0.4)

end

-- ---------------------------------------------------
-- secuencia de visualización de la posición de salida del defensor
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_defensor", false, 0.65 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_ATACANTE_2")
  ...
  fade_color (255,255,255,255, 255,255,255,0,0,0.8)
  fade_color (255,255,255,0, 255,255,255,255,maxTime-0.4,0.4)
  
end

-- ---------------------------------------------------
-- secuencia de visualización de la entrada abierta
-- ---------------------------------------------------
function secuencia3 ()
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm01.V3D", "LOC_entrada1", false, 0.55 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_ATACANTE_3")
