...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_defensor", false, 0.95 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_DEFENSOR_2")
...
function secuencia3 ()
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm01.V3D", "LOC_entrada1", false, 0.8 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LETONIA_DEFENSOR_3")
