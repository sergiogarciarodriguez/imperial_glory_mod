...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ANATOLIA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraObjetivoAnatolia.V3D", 0.0,false,1 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ANATOLIA_ATACANTE_2")
