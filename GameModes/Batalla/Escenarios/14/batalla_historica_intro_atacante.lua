...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara14Bohemia.V3D",0,false,1.0);
  time2 = reproduce_texto ("LTEXT_HISTORICA_AUSTERLITZ_ATACANTE")
  time3 = reproduce_locucion ("S_HB_AUSTERLITZ_ATTACK")
