...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_DINAMARCA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm03.V3D", "LOC_Aldea", false, 0.9)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_DINAMARCA_ATACANTE_2")
