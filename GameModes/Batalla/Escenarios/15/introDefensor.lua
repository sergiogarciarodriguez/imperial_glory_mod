...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara15Galizia.V3D", 0.0, false, 1.0);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_GALIZIA_DEFENSOR_1")
  ...
  fade_color (240,245,220,0, 240,245,220,255, maxTime-0.3,0.3)

end

-- ---------------------------------------------------
-- secuencia de visualización de la casa
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg03.V3D", "LOC_Granja", false, 1.0)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_GALIZIA_DEFENSOR_2")
  ...
  fade_color (240,245,220,255, 240,245,220,0, 0,0.6)
  fade_color (255,255,255,0, 255,255,255,255, maxTime-1.3,1.3)
