...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CHAMPAGNE_ATACANTE_1")
  ...
  fade_color (255,255,255,0, 255,255,255,255,maxTime-0.9, 0.9)

end

-- -----------------------------------------
-- secuencia de visualización de la mansión
-- -----------------------------------------
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CHAMPAGNE_ATACANTE_2")
