...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_KURSK_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Bosque1" , false, 0.54)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_KURSK_ATACANTE_2")
