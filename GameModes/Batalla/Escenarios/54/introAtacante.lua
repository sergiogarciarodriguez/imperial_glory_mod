...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara54Moldavia.V3D",0.0,false,1);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MOLDAVIA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraAldeaMoldavia.V3D", 0.0, false, 1 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MOLDAVIA_ATACANTE_2")
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraGranjaMoldavia.V3D", 0.0, false, 1 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MOLDAVIA_ATACANTE_3")
