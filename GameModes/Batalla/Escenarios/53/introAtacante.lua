...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_EPAPALES_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg03.V3D", "LOC_Aldea",false,0.7 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_EPAPALES_ATACANTE_2")
