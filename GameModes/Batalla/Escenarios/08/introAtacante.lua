...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PARIS_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg01.V3D", "LOC_Madeleine",false,0.8 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PARIS_ATACANTE_2")
...
function secuencia3 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PARIS_ATACANTE_3")
...
function secuencia4 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PARIS_ATACANTE_4")
