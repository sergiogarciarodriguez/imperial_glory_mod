...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PRUSIAORIENTAL_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Bosque1" , false, 0.75)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PRUSIAORIENTAL_DEFENSOR_2")
  ...
  fade_color (245,255,240,255, 245,255,240,0, 0,2.0)
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg03.V3D", "LOC_Bosque2", false, 0.7)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PRUSIAORIENTAL_DEFENSOR_3")
