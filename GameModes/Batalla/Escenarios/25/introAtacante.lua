...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CATALUNYA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Masia", false, 0.65)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CATALUNYA_ATACANTE_2")
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg01.V3D", "LOC_Aldea" , false, 0.8)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CATALUNYA_ATACANTE_3")
