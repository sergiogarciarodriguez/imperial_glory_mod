...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_TUNEZ_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Jaimas", false, 0.77 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_TUNEZ_ATACANTE_2")
