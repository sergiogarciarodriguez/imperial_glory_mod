...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LOMBARDIA_ATACANTE_1")
...
-- ---------------------------------------------------
-- secuencia de visualización de la aldea sur
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm01.V3D", "LOC_AldeaSur", false, 0.85)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LOMBARDIA_ATACANTE_2")
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm03.V3D", "LOC_torreon", false, 1.3)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LOMBARDIA_ATACANTE_3")
  ...
  fade_color (255,255,255,255, 255,255,255,0,0,0.4)
  fade_color (255,255,255,0, 255,255,255,255,maxTime-1.0,1.0)
  
end

-- ---------------------------------------------------
-- secuencia de visualización de la aldea central
-- ---------------------------------------------------
function secuencia4 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm02.V3D", "LOC_AldeaCentral", false, 0.8 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LOMBARDIA_ATACANTE_4")
