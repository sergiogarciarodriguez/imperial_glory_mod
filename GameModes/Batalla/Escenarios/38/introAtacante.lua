...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SUECIA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm02.V3D", "LOC_Aldea", false, 0.7)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SUECIA_ATACANTE_2")
  ...
  temporizador ( maxTime, "comenzar_batalla" )
  fade_color (240,240,255,255, 240,240,255,0,0,4)
