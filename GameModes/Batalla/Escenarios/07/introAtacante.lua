...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara07Toulose.V3D",0.0, false, 1);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_TOULOUSE_ATACANTE_1")
...
-- ---------------------------------------------------
-- secuencia de visualización de la primera granja
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg03.V3D", "LOC_Granja1", false, 0.6)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_TOULOUSE_ATACANTE_2")
...
-- ---------------------------------------------------
-- secuencia de visualización de la segunda granja
-- ---------------------------------------------------
function secuencia3 ()
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm02.V3D", "LOC_Granja2", false, 1.0)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_TOULOUSE_ATACANTE_3")
