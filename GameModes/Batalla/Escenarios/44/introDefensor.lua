...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PIAMONTE_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PIAMONTE_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_PIAMONTE_DEFENSOR_3")
