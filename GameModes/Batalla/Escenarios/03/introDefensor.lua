...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara03Irlanda.V3D",0.0,false,0.32);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_IRLANDA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_IRLANDA_DEFENSOR_2")
