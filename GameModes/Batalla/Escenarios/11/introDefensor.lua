...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SILESIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Bosque2", false, 0.7)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SILESIA_DEFENSOR_2")
