...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SAJONIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm03.V3D", "LOC_Granja", false, 0.65 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SAJONIA_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Aldea", false, 0.62 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_SAJONIA_DEFENSOR_3")
