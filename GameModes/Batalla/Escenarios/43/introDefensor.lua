...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CIRENAICA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraJaimaCirenaica01.V3D", 0.0, false, 0.8)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CIRENAICA_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CIRENAICA_DEFENSOR_3")
...
function secuencia4 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraJaimaCirenaica02.V3D", 0.0, false, 0.9 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CIRENAICA_DEFENSOR_4")
