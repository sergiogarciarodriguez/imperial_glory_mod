...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ESCOCIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ESCOCIA_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ESCOCIA_DEFENSOR_3")
...
function secuencia4 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_ESCOCIA_DEFENSOR_4")
