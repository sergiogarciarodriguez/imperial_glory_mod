...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CASTILLA_ATACANTE_1")
...
function secuencia2 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CASTILLA_ATACANTE_2")
...
function secuencia3 ()
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/CamarasPresentacion/CamaraEdifBg02.V3D", "LOC_Aldea", false, 1.0);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_CASTILLA_ATACANTE_3")
