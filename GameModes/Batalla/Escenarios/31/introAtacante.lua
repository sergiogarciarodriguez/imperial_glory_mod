...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_REGIONBALCANICA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm02.V3D", "LOC_Granja", false, 0.8)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_REGIONBALCANICA_ATACANTE_2")
