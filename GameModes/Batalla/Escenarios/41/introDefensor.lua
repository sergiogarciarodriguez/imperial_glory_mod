...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_VENECIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifBg02.V3D", "LOC_Palacete", false, 0.65)
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_VENECIA_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_VENECIA_DEFENSOR_3")
