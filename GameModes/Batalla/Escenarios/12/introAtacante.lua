...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara12Polonia.V3D",0.0,false,1);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_POLONIA_ATACANTE_1")
  ...
  fade_color (230,235,255,0,235,230,255,255,maxTime-2,2)

end

-- ---------------------------------------------------
-- secuencia de visualización del pueblo
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraObjetivoPolonia.V3D", 0.0, false, 1 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_POLONIA_ATACANTE_2")
  ...
  temporizador ( maxTime, "comenzar_batalla" )
  fade_color (230,235,255,255, 230,235,255,0,0,3)
