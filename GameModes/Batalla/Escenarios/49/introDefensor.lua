...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BATAVIA_DEFENSOR_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/Camaraspresentacion/CamaraTBatavia1.V3D",0.0,false,0.6);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BATAVIA_DEFENSOR_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BATAVIA_DEFENSOR_3")
...
function secuencia4 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BATAVIA_DEFENSOR_4")
