...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_KIEV_DEFENSOR_1")
  ...
  fade_color (240,250,255,255, 240,250,255,0,0,1.5)
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_KIEV_DEFENSOR_2")
