...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_GRECIA_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm02.V3D", "LOC_Ruinas1", false, 0.6 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_GRECIA_ATACANTE_2")
  ...
  fade_color (235,245,255,0, 245,245,225,255,maxTime-0.7,0.7)
...
function secuencia3 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm03.V3D", "LOC_Ruinas3", false, 0.78 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_GRECIA_ATACANTE_3")
    
  -- Determinamos las mayor duración de todas las acciones
  maxTime = max (time1, time2) - 1
    
  -- Pasamos a la secuencia 3 cuando pase el tiempo maximo de las acciones reproducidas
  temporizador ( maxTime, "comenzar_batalla" )
  fade_color (245,245,225,255, 245,250,255,0,0,1)
