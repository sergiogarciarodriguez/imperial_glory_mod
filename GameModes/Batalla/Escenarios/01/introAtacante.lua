...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LONDRES_ATACANTE_1")
...
-- ---------------------------------------------------
-- secuencia de visualización de la Torre de Londres
-- ---------------------------------------------------
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LONDRES_ATACANTE_2")
...
function secuencia3 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LONDRES_ATACANTE_3")
...
function secuencia4 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_LONDRES_ATACANTE_4")
