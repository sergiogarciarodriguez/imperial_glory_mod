...
function secuencia1 ()
  ...
  time1 = reproduce_camara ("game/gameModes/Batalla/CamarasPresentacion/CamarasEscenarios/Camara09Bretana.V3D",0.0,false,1.0);
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BRETANA_ATACANTE_1")
  ...
  fade_color (235,255,245,255, 235,255,245,0,0.0,1)
  fade_color (235,255,245,0, 235,255,245,255,maxTime-0.9,0.9)
...
function secuencia2 ()  
  ...
  time1 = reproduce_camara_relativa ("game/gameModes/Batalla/Camaraspresentacion/CamaraEdifSm01.V3D", "LOC_Torre", false, 0.65 )
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_BRETANA_ATACANTE_2")
  ...
  fade_color (235,255,245,255, 235,255,245,0,0.0,1.9)
