...
function secuencia1 ()
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MARRUECOS_ATACANTE_1")
...
function secuencia2 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MARRUECOS_ATACANTE_2")
...
function secuencia3 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MARRUECOS_ATACANTE_3")
...
function secuencia4 ()  
  ...
  time2 = reproduce_texto ("LTEXT_TEXTUISECUENCIAS_MARRUECOS_ATACANTE_4")
